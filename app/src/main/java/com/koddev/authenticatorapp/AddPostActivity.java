...
public class AddPostActivity extends AppCompatActivity {
    ...
    private static final int IMAGE_PICK_GALLERT_CODE = 400;
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(AddPostActivity.this,"已更新",Toast.LENGTH_SHORT).show();
    ...
    private void updateWithNowImage(final String title, final String description, final String editPostId) {
        ...
        ref.putBytes(data)
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(AddPostActivity.this,"",Toast.LENGTH_SHORT);
            }
        });
                    ...
                    if (uriTask.isSuccessful()){
                        ...
                        ref.child(timeStamp).setValue(hashMap)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        pd.dismiss();
                                        Toast.makeText(AddPostActivity.this, "發布成功", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
            ...
            case CAMERA_REQUEST_CODE:{
                if(grantResults.length>0){
                    ...
                    if (camerAccepted && storageAccepted){
                        ...
                        Toast.makeText(this, "Camera & Storga both permissions are neccessary...", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
            ...
            case STORAGE_REQUEST_CODE:{
                if (grantResults.length>0){
                    ...
                    if (storageAccepted){
                        ...
                        Toast.makeText(this, "Storga permissions neccessary...", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
